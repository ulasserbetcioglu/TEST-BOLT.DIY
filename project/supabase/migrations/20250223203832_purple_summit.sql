...
CREATE INDEX IF NOT EXISTS idx_application_services_service_type_id ON application_services(service_type_id);

CREATE INDEX IF NOT EXISTS idx_application_equipment_application_id ON application_equipment(application_id);
CREATE INDEX IF NOT EXISTS idx_application_equipment_equipment_id ON application_equipment(equipment_id);
