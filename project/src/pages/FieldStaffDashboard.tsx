...
import { Building2, FileText, Settings, TrendingUp, LogOut, Clock, AlertCircle, Hash } from 'lucide-react';

interface FieldStaffProfile {
  id: string;
  name: string;
  email: string;
  phone: string;
...
export default function FieldStaffDashboard() {
  ...
  const [profile, setProfile] = useState<FieldStaffProfile | null>(null);
          ...
          <div className="px-6 py-8 bg-gradient-to-r from-blue-600 to-blue-700">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="mt-1 text-blue-100">Saha Personeli Paneli</p>
              </div>
              <button
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="mt-1 text-gray-600">{profile.staff_code}</p>
                  </div>
                </div>
              </div>
